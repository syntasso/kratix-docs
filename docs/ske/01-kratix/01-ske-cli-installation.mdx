...
TODO: Write docs for SKE CLI upgrades after completion of https://github.com/syntasso/enterprise-kratix/issues/95

The upgrade will fail in the following circumstances:
