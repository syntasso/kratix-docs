---
title: Via SKE CLI
description: Installing Syntasso Kratix Enterprise using the SKE CLI
---
...
CLI](../../releases/ske-cli). The CLI will install the SKE Operator and
...
follow the [helm upgrade](./via-helm) instructions for upgrading SKE.
