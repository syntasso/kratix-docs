...
The SKE Operator provides full lifecycle support for Syntasso Kratix Enterprise (SKE).
...
ongoing reconciliation of your Kratix installation against the desired distritution.
