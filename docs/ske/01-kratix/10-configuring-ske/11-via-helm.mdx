...
::note
As of SKE Operator 0.13.0, deleting the SKE Operator will not delete your SKE instance, CRDs or registry secret. To
delete these which deleting the operator, ensure the operator is deployed with `global.skeDeployment.deleteOnUninstall`
set to true
::
