...
unless your are configuring [custom certificates](#custom-certs). Please
...
manifests directly. Check [SKE Operator](./configuring-ske/via-manifest) for the instructions.
...
[directly applying the manifests](./via-manifests).
