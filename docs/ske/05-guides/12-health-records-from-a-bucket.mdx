...
Every field, condition reason and the metadata the reader stamps on each record are documented
in the [Health Source reference](/ske/reference/healthsource).
