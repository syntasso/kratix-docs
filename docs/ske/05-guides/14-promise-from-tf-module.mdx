...
```yaml
docker build -t my-registry.io/my-org/kratix/terraform-dependencies:v0.0.1:v0.1.0 workflows/promise/configure/dependencies/add-tf-dependencies
kind load docker-image my-registry.io/my-org/kratix/terraform-dependencies:v0.0.1:v0.1.0 -n platform
```
