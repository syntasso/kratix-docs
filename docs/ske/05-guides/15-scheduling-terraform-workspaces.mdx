...
For that, we will use the S3 Bucket example Promise available [here](https://github.com/syntasso/kratix-examples/tree/main/s3-bucket-promise). You can install the Promise with the following command:
