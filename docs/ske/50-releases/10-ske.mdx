...
### [v0.22.0](http://syntasso-enterprise-releases.s3-website.eu-west-2.amazonaws.com/#ske/v0.22.0/) (2025-03-XX)

#### Features

* Destination `spec.path` is required [Destination Reference](/main/reference/destinations/destinations).
