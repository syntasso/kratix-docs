...
* Introduces the **Portal Controller**, a unified integration that syncs Kratix Promises and Resource requests into developer portals. Configure Backstage or Cortex portals via `SKEIntegration type: portal-controller`. The standalone Backstage and Cortex controllers are deprecated in favour of this integration. See the [Portal Controller documentation](/ske/integrations/portal-controller/intro).
