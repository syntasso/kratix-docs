...
slug: /ske/releases/promise-testing-framework
---
...
Set your [Syntasso Enterprise Release Token](../reference/tokens#enterprise-releases-token) as the value of the `GH_TOKEN` environment variable.
