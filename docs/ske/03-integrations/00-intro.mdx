...
* In [Hashicorp Cloud Platform](./ske/integrations/terraform), you will find
  information about the HCP aspect, which integrates Kratix Promises with
  [Hashicorp Cloud Platform](https://www.hashicorp.com/cloud) (both Terraform
