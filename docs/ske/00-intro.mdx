---
title: Syntasso Kratix Enterprise (SKE) Introduction
description: Syntasso Kratix Enterprise is the supported, enterprise-ready distribution of Kratix, with a GUI, integrations, and dedicated support.
