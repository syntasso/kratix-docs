---
title: For air-gapped environments
...
With the mirrors in place, you can install SKE via the Helm chart. Refer to the [installation guide](/ske/installing-ske/advanced-setup#via-helm-chart) for more details, and make sure to configure the [air-gapped mirrors](/ske/installing-ske/advanced-setup#air-gapped-mirrors).