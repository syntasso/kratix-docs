...
Syntasso Kratix Enterprise (SKE) with a **preconfigured Backstage**. It is the fastest way to get started with SKE. It is not
intended for production use, but rather to get you started and experimenting
quickly. Check the [advanced installation](/ske/installing-ske/advanced-install)
guide for alternatives for production use.
