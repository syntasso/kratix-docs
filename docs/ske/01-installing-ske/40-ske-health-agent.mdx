...
If your State Store is a bucket, the SKE Platform Manager can read health records from it
directly, instead of you running a GitOps agent on the Platform to sync them. See
