...
With a bucket you have the choice described in [Requirements](#requirements): let the SKE
Platform Manager read the records itself rather than syncing them with a GitOps agent. See
[Move health records onto a bucket](/ske/guides/health-records-from-a-bucket).
