...
This page covers the advanced installation using the SKE Operator — the recommended approach for 
production, or any environment where you need to customise or secure your SKE installation, 
via either the Operator's Helm chart or its manifests directly.

If you're setting up a quick development or test environment instead, 
[Preconfigured installation](./preconfigured-install) will get you there faster. If your 
cluster is air-gapped, complete [Air-gapped installation](./air-gapped) first — you'll need 
your image registry and release manifest mirrors in place before running the commands below.
