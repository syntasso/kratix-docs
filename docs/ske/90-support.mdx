...
Preview Features are available to SKE customers who would like early access to selected integrations and capabilities. They provide an opportunity to explore new functionality and share feedback with the Syntasso team before general availability.

Preview Features are still evolving. They may change, have limited documentation, or not yet meet the stability standards of fully released features. As such, they are not covered by standard support SLAs and we recommend careful evaluation before using them in production environments.

If you are considering a Preview Feature, please contact Syntasso to discuss suitability, intended use, and expectations.

All Preview Features are clearly marked in the documentation.
