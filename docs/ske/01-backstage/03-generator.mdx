...
[Kratix Backstage docs](https://docs.kratix.io/main/reference/backstage/intro#setting-up-kratix-with-backstage)
...
<details>
  ...
  <CodeBlock language="yaml" title="Promise Component manifest">
...
<details>
  ...
  <CodeBlock language="yaml" title="Promise Template manifest">
...
<details>
  ...
  <CodeBlock language="yaml" title="Resource Component manifest">
  apiVersion: backstage.io/v1alpha1
  kind: Component
  metadata:
