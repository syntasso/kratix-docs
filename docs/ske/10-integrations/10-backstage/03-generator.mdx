...
```bash
docker pull ghcr.io/syntasso/ske-backstage-generator:VERSION
```
...
```bash
# For minikube
minikube image load ghcr.io/syntasso/ske-backstage-generator:VERSION

# For KinD
kind load docker-image ghcr.io/syntasso/ske-backstage-generator:VERSION
```
    ...
    promise:
      ...
      - apiVersion: platform.kratix.io/v1alpha1
        ...
        spec:
          ...
          #highlight-start
          - image: ghcr.io/syntasso/ske-backstage-generator:VERSION
