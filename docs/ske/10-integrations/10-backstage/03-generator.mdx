...
your [Backstage Destination](#destination). **You must ensure this is only run
once across all your pipelines** in a workflow. In order to
have the full status displayed in Backstage, you should place the aspect as the
last image in the last pipeline of your workflow. If you have this more than
once in your workflow, you will see a random one of the components in Backstage,
and Backstage will emit a warning:
