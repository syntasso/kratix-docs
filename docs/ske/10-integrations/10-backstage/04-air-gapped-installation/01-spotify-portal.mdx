...
In air-gapped environments, you must mirror the Backstage Controller images and deployment manifests into your own infrastructure before installing. Once mirrored, follow the standard [Installing the Backstage Controller](../installation/generating-backstage-components#installing-the-backstage-controller) steps.

### Mirroring the Backstage Controller Images
