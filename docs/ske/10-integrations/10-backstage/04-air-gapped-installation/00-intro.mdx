...
Entity generation uses the [Portal Controller](/ske/integrations/portal-controller/intro). If you are still running the standalone Backstage Controller, it continues to work, see [Migrating from the Backstage Controller](/ske/integrations/portal-controller/backstage/migrating-from-backstage).
