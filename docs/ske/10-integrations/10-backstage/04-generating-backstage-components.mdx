...
The Backstage Controller chart will use secret `syntasso-registry`, which is created and managed by the ske operator helm chart.
...
imageRegistry:
  imagePullSecret: "my-own-secret-name"
...
```
