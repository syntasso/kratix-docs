...
- Follow the [Backstage Destination](https://docs.kratix.io/ske/integrations/backstage/configuring-backstage#configuring-kratix) documentation to configure Kratix to manage the component an template configuration.
