...
For more advanced or production-ready customization, see the [Configuring Backstage](/ske/integrations/backstage/installation/configuring-backstage) documentation.
...
- Follow the [Backstage Destination](/ske/integrations/backstage/installation/configuring-backstage#configuring-kratix) documentation to configure Kratix to manage the component and template configuration.
