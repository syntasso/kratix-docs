...
## Accessing the SKE Backstage Generator Pipeline Stage
...
you should place the Pipeline Stage as the last Stage in the last pipeline of your workflow.
...
When configuring your Backstage destination, you can optionally choose to write a single
...
To do this, update your Backstage destination to look like the example below:
...
With the change above, all resources and promises components will be combined
into a single `catalog-info.yaml` file in the State Store.
