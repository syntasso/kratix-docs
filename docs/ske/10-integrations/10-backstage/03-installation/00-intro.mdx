...
- **Backstage v1.24+**: The SKE plugins are compatible with Backstage v1.24 and above (tested up to v1.50.4). If you are running v1.23 or lower, refer to the Backstage [migration guide](https://backstage.io/docs/backend-system/building-backends/migrating)
- **Node.js 22+**: Required for Backstage v1.50+. Ensure your build environment and Docker images use Node 22+

- **Syntasso registry token**: Required to install the private SKE npm packages. Contact Syntasso if you do not have one.
