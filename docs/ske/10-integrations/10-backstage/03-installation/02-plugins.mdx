...
The [next guide](/ske/integrations/portal-controller/backstage/pipeline-stage) will show how you can use the SKE Backstage Generator to automatically generate Backstage entities from your Promises. If you want to manually
configure your Promises, check the [YAML File Format](/ske/integrations/portal-controller/backstage/entity-yaml-format) reference.
