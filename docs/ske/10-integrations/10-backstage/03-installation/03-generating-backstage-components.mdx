...
- **SKE Operator**: Installed at v0.28.0 or later. If you haven't installed the Operator, please refer to the [SKE installation guide](../../../installing-ske/install-with-operator).
...
Promise and Resource metadata. See [Configure Backstage](/ske/integrations/portal-controller/backstage/configure-backstage) for installation instructions.
...
The Backstage Controller is installed by the [SKE Operator](../../../installing-ske/install-with-operator) and can be deployed via the SKE Operator Helm Chart.
...
See the [Entity YAML format](/ske/integrations/portal-controller/backstage/entity-yaml-format) for examples of these manifests
