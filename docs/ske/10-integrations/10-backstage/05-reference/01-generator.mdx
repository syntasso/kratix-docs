...
See [Configure Backstage](/ske/integrations/portal-controller/backstage/configure-backstage) for instructions.
...
Check the [Entity YAML format](/ske/integrations/portal-controller/backstage/entity-yaml-format) for examples of these manifests.
