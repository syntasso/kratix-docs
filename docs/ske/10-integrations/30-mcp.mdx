...
To get started, you will need a SKE or SKA token. You can request a token via the [Syntasso](https://www.syntasso.io/pricing) website by clicking the "Try SKE Today" button.
