...
stringData:
  ...
  address: <TFE URL ENDPOINT> (optional, defaults to https://app.terraform.io)
```
          ...
          spec:
            rbac:
              ...
              - apiGroups:
                ...
                resourceNamespace: "*"
            containers:
              - image: ghcr.io/syntasso/ske-tfstate-finder:latest
                name: fetch-output
                env:
                - name: TIMEOUT
                  value: "30m"
...
image, you will need to use the [Syntasso registry token](../reference/tokens#syntasso-registry-token)
provided by Syntasso and your Kubernetes cluster must have the permissions to pull images from the registry.
