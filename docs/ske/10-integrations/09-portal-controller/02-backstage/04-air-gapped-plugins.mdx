---
title: Air-Gapped Plugin Installation
description: Publishing the SKE Backstage plugins to an internal registry for air-gapped or network-restricted environments.
sidebar_label: Air-Gapped Plugin Installation
slug: air-gapped-plugins
keywords: [portal, backstage, plugin, air-gapped, spotify portal, npm registry]
---

In air-gapped or network-restricted environments, your Backstage may not be able to reach the public npm registry to install SKE plugins directly. You must first publish the plugins to an internal registry accessible from your Backstage instance, then follow the standard [installation and configuration steps](./configure-backstage).
