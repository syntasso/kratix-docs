...
:::important
Pull-request mode requires a backend version that provides the request-recording action. See the
[requirements table](../installation#requirements) for minimum versions.
:::
