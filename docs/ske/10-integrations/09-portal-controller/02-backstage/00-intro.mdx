...
- [Shaping the request form](./shaping-the-request-form) covers how your Promise API becomes the
  form your developers fill in, and how to change what it generates.
