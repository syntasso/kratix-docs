...
For more advanced or production-ready customization, see the [Configuring Backstage](/ske/integrations/backstage/installation/configuring-catalogue-ingestion) documentation.
        ...
        - name: SA_TOKEN
          valueFrom:
            secretKeyRef:
              ...
              key: token
        image: ghcr.io/syntasso/backstage-dev-build:latest
...
<img align="right" src={useBaseUrl('/img/backstage-login.png')} />
...
- Follow the [Backstage Destination](/ske/integrations/backstage/installation/creating-entity-state-store#configure-a-destination-for-backstage) documentation to configure Kratix to manage the component and template configuration.
- Use and configure automatic [access to your Promises in Backstage](/ske/integrations/backstage/installation/generating-backstage-components).
