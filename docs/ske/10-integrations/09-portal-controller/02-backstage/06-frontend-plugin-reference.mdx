...
**Example: WebApp Promise**

For a WebApp Promise, the tab displays:

<figure className="diagram">
  <img
    className="fullwidth"
    src={PromiseOverview}
    alt="The Backstage Kratix tab for the WebApp Promise, showing its API details, status, create button and relations"
  />
  <figcaption>The WebApp Promise in Backstage</figcaption>
</figure>
...
It provides the Overview tab content for a Promise, and the Status tab content
