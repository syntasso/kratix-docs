...
The pull-request update and deletion behaviour is not included in
`ske-frontend` v0.17.6. Use a later release that includes the pull-request
Resource workflow before configuring these annotations.
