---
description: Role Based Access Control (RBAC) in Kratix
title: Role Based Access Control (RBAC) in Kratix
id: rbac
---
...
Below *is just an example*. Your actual Platform Engineer role may differ based
on your organisational needs and the Promises you have installed. Always follow
the principle of least privilege when assigning permissions.
