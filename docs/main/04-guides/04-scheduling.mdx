...
:::info
If you are specifically interested in making a Resource location deterministic, you can check out the [scheduling workloads](../reference/multidestination-management#resources) reference.
:::
