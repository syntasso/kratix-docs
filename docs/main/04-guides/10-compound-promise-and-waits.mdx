...
```Dockerfile title="app-stack-wait-for-dependencies:v0.1.0"
FROM alpine:3.20
...
NAME                                              READY   STATUS              RESTARTS   AGE
app-stack-58b99c69cc-982m4                        0/1     ContainerCreating   0          4s
app-stack-app-stack-db-postgresql-0               1/1     Running             0          37s
nginx-nginx-ingress-controller-758c9cb6fc-jcfd7   1/1     Running             0          17m
postgres-operator-578ff5d886-9ztf6                1/1     Running             0          17m
```
