...
Kratix understands some status fields
- healthStatus:
    state: healthy | ...
    details: {}

You can use these fields to tell Kratix about the state of your resource

You can use HealthRecord to make Kratix automatically update the status

Check the reference docs for the CRD format
