...
For the most up to date information on installing Flux, see the 
[Flux documentation](https://fluxcd.io/docs/installation/). The simplest method
of installaton is to use the latest FluxCD release manifest from the Flux GitHub:
...
## Configuring Flux
### Configuring access to the StateStore
...
### Configuring Flux to deploy resources from the StateStore
