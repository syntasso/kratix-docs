...
We will use the [Kratix cli](main/kratix-cli) for promise writing. Please install the cli before continuing.
...
You can take a look at the provisioned database by targeting the destination
```bash
