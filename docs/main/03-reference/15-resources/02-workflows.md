...
- adds `kratix.io/workflow-suspend: "true"` to the Resource request
...
- A [Manual Reconciliation](/main/reference/resources/reconciliation-labels#manual-reconciliation)
is triggered
