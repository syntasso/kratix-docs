...
- via a [Workflow](/main/reference/resources/workflows) that is executed as part of every request for a Resource (as well as on updates and periodic reconciliation)
- via Kratix [scheduling](/main/reference/destinations/multidestination-management) workloads using GitOps
