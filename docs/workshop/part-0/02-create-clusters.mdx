...
Kratix schedules workloads to destination clusters by writing a state declaration (following the Kubernetes
...
[Flux](https://fluxcd.io/) on the destination cluster, and configure it to reconcile the
