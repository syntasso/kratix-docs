...
This states that the App-as-a-Promise needs the PostgreSQL Promise to be installed at version `v1.0.0-beta.1`. You can read more about Promise versioning [in the reference documentation](/main/reference/promises/releases#promise-release).
