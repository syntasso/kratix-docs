...
Create a `database-configure` file in the `workflows/resource/configure/mypipeline/kratix-workshop-app-pipeline-image/scripts` directory and make it executable. Next, copy the contents of [this file](https://raw.githubusercontent.com/syntasso/kratix-docs/refs/heads/main/docs/workshop/part-ii/_partials/compound-promise/02-database-configure) into it by running the following:

```bash
curl -o workflows/resource/configure/mypipeline/kratix-workshop-app-pipeline-image/scripts/database-configure --silent https://raw.githubusercontent.com/syntasso/kratix-docs/refs/heads/main/docs/workshop/part-ii/_partials/compound-promise/02-database-configure
```
