...
<Tabs>
  <TabItem value="darwin-amd64" label="Intel Mac" default>
    ...
    mkdir -p bin
    curl -sLo ./bin/worker-resource-builder https://github.com/syntasso/kratix/releases/download/v0.0.3/worker-resource-builder_0.0.3_darwin_amd64.tar.gz
  ...
  <TabItem value="linux-arm64" label="Linux ARM64">
    ...
    mkdir -p bin
    curl -sLo ./bin/worker-resource-builder https://github.com/syntasso/kratix/releases/download/v0.0.3/worker-resource-builder_0.0.3_linux_arm64.tar.gz
    tar -xvf ./bin/worker-resource-builder -C ./bin
    chmod +x ./bin/worker-resource-builder
    ...
    mkdir -p bin
    curl -sLo ./bin/worker-resource-builder https://github.com/syntasso/kratix/releases/download/v0.0.3/worker-resource-builder_0.0.3_linux_amd64.tar.gz
    tar -xvf ./bin/worker-resource-builder -C ./bin
    chmod +x ./bin/worker-resource-builder
