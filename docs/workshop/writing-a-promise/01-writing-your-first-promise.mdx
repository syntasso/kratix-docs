...
Kratix is a framework used by platform teams to build platforms tailored to their organisation and through Promises, teams can build their platforms incrementally.
