...
To complete this workshop, you will need to have access to an installation of Kratix as well as some essential tools. Take a look at the [Prerequisites](../prerequisites/intro) to
ensure your environment is correctly configured.

## What is a Promise? {#what-is-a-promise}

Kratix is a framework used by platform teams to build platforms tailored to their organisation.
