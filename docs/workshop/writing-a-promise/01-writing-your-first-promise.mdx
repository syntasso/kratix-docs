...
## <span id="prequisites">Prerequisites</span>
...
## <span id="what-is-a-promise">What is a Promise?</span>

Kratix is a framework used by platform teams to build platforms tailored to
their organisation.
...
### <span id="api-design">Design an API for your service</span>
...
### <span id="dependencies">Define the dependencies</span>
...
curl -o dependencies/dependencies.yaml --silent https://raw.githubusercontent.com/syntasso/kratix-docs/main/docs/workshop/writing-a-promise/_partials/nginx-patched.yaml
```
...
### <span id="workflow">Define the Workflow</span>
...
### <span id="install-the-promise">Install the Promise</span>
...
## <span id="using-the-app-promise">Using the App Promise</span>
