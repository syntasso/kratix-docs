...
This updates the permissions of the Kratix Pipeline Service Account to allow it to create and retrieve ConfigMaps. You can read more about how to configure RBAC permission in Pipelines in the [Kratix reference documentation](/main/reference/workflows#role-based-access-control-rbac).
