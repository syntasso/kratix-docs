...
This section assumes you have a SKE License token, have access to the SKE Backstage plugins, and installed them in your Backstage instance (or that you have cloned the [example Backstage app](https://github.com/syntasso/blog-backstage-oidc)). If that's not your case,you can follow a step-by-step guide on how to configure the SKE Backstage plugins [here](/ske/integrations/portal-controller/backstage/configure-backstage).
