...
Those Promises are all available in the [Kratix Marketplace](/marketplace). All the pipeline needs to do is generate the requests to those sub-promises based on the user's input.
