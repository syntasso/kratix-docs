...
* Installing and managing your Compound Promise.
...
Luckly, all the sub-promises you need to build this Compound Promise are available in the [Kratix Marketplace](/marketplace):
