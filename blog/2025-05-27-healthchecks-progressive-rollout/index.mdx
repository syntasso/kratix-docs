...
1. include a container that outputs a HealthDefinition to check Postgres health
1. include an additional container that uses Kubernetes Leases to ensure it only continues the workflow when it acquires the lease
...
Check out our [step-by-step guide](/ske/guides/healthchecks) to get started, and let us know how you’re using them—we’d love to hear from you in our Slack or GitHub communities.
