...
<!-- truncate -->
Our community has shared with us the challenges of bootstrapping custom Promise workflows. They often resort to bash scripts 
...
- **Interacting with Kratix-specific components:** It simplifies access to API fields as environment variables and fetching 
resource request details for compound Promises, making complex interactions simple.
...
SDK repositories on GitHub, or the contract in the [Kratix.io](https://www.Kratix.io) repo and let us know your thoughts!
